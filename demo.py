...
with st.form('text'):
    ...
    if button:
        ...
        labels = [
            ...
            "securities account", "Certificate of deposit", "Internet banking facilities", "Credit Card",
            "Has mortgage",
        ...
        st_shap(shap.force_plot(explainer.expected_value, shap_values[0, :],
                                ready_to_predict.iloc[0, :], out_names='probability of prediction',
                                feature_names=labels, link='logit'))
